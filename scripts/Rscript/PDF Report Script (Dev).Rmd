---
title: 'State of the Smallholder Coffee Farmer Platform: Indicator Report'
output:
  pdf_document:
    toc_depth: 1
  html_document:
...
- \pagestyle{fancy}
- \fancyfoot{}
- \fancyfoot[LO,LE]{Note; If values have been converted to standard units, original
  values and conversion rates will be available in the indicator excel download.}
- \fancyhead[L]{\thepage}
---
