        ...
        <div class="row">
            <div class="col-md-6 px-5 pt-5">
                ...
                <div class="d-flex justify-content-center mt-5 mb-5">
                    <a href="docs/State of the Smallholder Coffee Farmer.pdf"><button class="button-green">Download English <i class='las la-arrow-down'></i></button></a>
                </div>
            </div>
            <div class="col-md-6 px-5 pt-5">
                <div class="d-flex justify-content-center">
                ...
                <div class="d-flex justify-content-center mt-5 mb-5">
                    <a href="docs/Situacion de los pequenos caficultores.pdf"><button class="button-green">Download Spanish <i class='las la-arrow-down'></i></button></a>
                </div>
            </div>            
        </div>
    </div>
