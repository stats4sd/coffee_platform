...
<div class="main-container">
        ...
        <div class="row justify-content-end">
            <div class="col-md-5 col-lg-4 box-green">
                <div class=" report-text ml-xl-4 mr-2 mr-xl-5 mt-xl-4">
                    ...
                    <p>The State of the Coffee Smallholder Platform is an open access data resource, designed to drive
                        more
                        informed decision making
                        amongst smallholder coffee farmers as well as various value chain actors.
                    </p>
                    <p>Indicator data about smallholder farmers in Guatemala, Honduras, and Nicaragua have been
                        collected together from a variety of sources
                        into one hub. This can be browsed and filtered to allow anyone to explore the information
                        available and find out about various aspects of
    ...
    <div class="container px-4 my-5 px-5 py-5">
        ...
        <p> The platform and the accompanied <a href="reports" style="color: #66AC47">report</a> complement other
            ...
            environmental data about coffee smallholders. While many initiatives focus on tracking and documenting
            coffee
            industry actors’ sustainability efforts, our approach is from the bottom up. Based on the available data, we
            are
            taking steps toward drawing a more holistic picture about coffee smallholders, their livelihoods, and the
            challenges they are facing. We are also seeking to identify data gaps, and envision how we could improve
            data
            collection and sharing among a variety of actors along the coffee value chain, including the farmers and
            their
            organizations.</p>
