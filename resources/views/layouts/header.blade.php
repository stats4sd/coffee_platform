...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark h-100 pl-4">
        <a class="navbar-brand" href="{{ route('home') }}" class="px-4"><h1 class="big-title d-flex d-sm-none">SSCF</h1><h1 class="big-title d-none d-sm-flex">State of the Smallholder Coffee Farmer</h1></a>
