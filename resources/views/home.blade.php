...
@section('main')
    ...
    <div class="container my-5 px-5 py-5">
            ...
            <p>The State of the Smallholder Coffee Farmer is an open access data resource, designed to drive more informed,
        ...
        <div class="row">
            <div class="mt-lg-5 pt-lg-5 col-lg-6">
                ...
                <p>Alongside the platform, a report describes key findings and the data collection process in detail.
                </p>
                <div class="d-flex justify-content-center mt-5 mb-5">
